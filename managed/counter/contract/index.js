...
export class Contract {
  ...
  constructor(...args_0) {
    ...
    this.circuits = {
      ...
      getCount: (...args_1) => {
        if (args_1.length !== 1) {
          throw new __compactRuntime.CompactError(`getCount: expected 1 argument (as invoked from Typescript), received ${args_1.length}`);
        }
        const contextOrig_0 = args_1[0];
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('getCount',
                                     'argument 1 (as invoked from Typescript)',
        ...
        const result_0 = this._getCount_0(context, partialProofData);
  ...
  initialState(...args_0) {
    ...
    state_0.setOperation('getCount', new __compactRuntime.ContractOperation());
                                      ...
                                      [
                                       ...
                                       { push: { storage: true,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_0.toValue(tmp_0),
                                                                                              alignment: _descriptor_0.alignment() }).encode() } },
                                       { ins: { cached: false, n: 1 } }]);
    const tmp_1 = this._ownerCommitment_0(_descriptor_0.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                                    partialProofData,
                                                                                                    [
                                                                                                     { dup: { n: 0 } },
                                                                                                     { idx: { cached: false,
  ...
  _ownerCommitment_0(r_0, sk_0) {
    return this._persistentHash_0([new Uint8Array([97, 110, 111, 110, 121, 109, 111, 117, 115, 45, 101, 120, 97, 109, 58, 99, 111, 117, 110, 116, 101, 114, 58, 111, 119, 110, 101, 114, 58, 0, 0, 0]),
                                   __compactRuntime.convertFieldToBytes(32,
                                                                        r_0,
                                                                        'counter.compact line 34 char 48'),
                                   sk_0]);
  }
  _increment_0(context, partialProofData, amount_0) {
    const sk_0 = this._secretKey_0(context, partialProofData);
    const pk_0 = this._ownerCommitment_0(_descriptor_0.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                                   partialProofData,
                                                                                                   [
                                                                                                    { dup: { n: 0 } },
                                                                                                    { idx: { cached: false,
    ...
    __compactRuntime.assert(this._equal_0(_descriptor_2.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                                    ...
                                                                                                    [
                                                                                                     ...
                                                                                                     { popeq: { cached: false,
                                                                                                                result: undefined } }]).value),
                                          pk_0),
                            'unauthorized: secret does not match owner');
    let t_0;
    __compactRuntime.assert((t_0 = amount_0, t_0 > 0n),
                            'amount must be positive');
    const tmp_0 = ((t1) => {
                    if (t1 > 18446744073709551615n) {
                      throw new __compactRuntime.CompactError('counter.compact line 54 char 20: cast from Field or Uint value to smaller Uint value failed: ' + t1 + ' is greater than 18446744073709551615');
                    }
                    return t1;
    ...
    __compactRuntime.queryLedgerState(context,
                                      ...
                                      [
                                       ...
                                       { ins: { cached: true, n: 1 } }]);
    const tmp_2 = this._ownerCommitment_0(_descriptor_0.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                                    partialProofData,
                                                                                                    [
                                                                                                     { dup: { n: 0 } },
                                                                                                     { idx: { cached: false,
